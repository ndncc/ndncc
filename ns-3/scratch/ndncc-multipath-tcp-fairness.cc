 ...
 */
// ndncc-multipath-tcp-fairness.cc Test whether creating multiple TCP flows is beneficial
...
main (int argc, char *argv[])
{
  ...
  topologyReader.SetFileName ("src/ndnSIM/examples/topologies/multipath.txt");
  ...
  Ptr<MyApp> app = CreateObject<MyApp> ();
	app->Setup (serversocket, clientAddr, 1140, 0, DataRate ("2Mbps"));	//0 means infinite packets
